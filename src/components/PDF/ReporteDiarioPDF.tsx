...
import type { DatosReporteDiario } from '@/types/Inventario/reportesEspecificos.types';
...
interface ReporteDiarioPDFProps {
  datos: DatosReporteDiario[];
  configuracion: any;
}

export const ReporteDiarioPDF: React.FC<ReporteDiarioPDFProps> = ({ 
  datos, 
  configuracion 
}) => {
  // Ordenar datos: tipo alfabético, luego peso descendente
      ...
      <Page key={i} size="A4" orientation="landscape" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.dateInfo}>
            Fecha: {configuracion.filtros.fecha} | 
        ...
        <View style={styles.table}>
          ...
          <View style={[styles.tableRow, styles.tableHeader]}>
            ...
            <View style={[styles.tableCellHeader, styles.colEstatus]}>
              <Text style={styles.tableCellHeader}>Estatus</Text>
            </View>
          ...
          {datosPagina.map((item, index) => (
            ...
            >
              ...
              <View style={[styles.tableCell, styles.colEstatus]}>
                <Text style={styles.tableCell}>
                  {item.estatus}
                </Text>
              </View>
