...
export function Indicators({ stats, loading }: IndicatorsProps) {
  return (
    <IndicatorsContainer
    ...
    >
      ...
      >
        ...
        <IndicatorContent>
          ...
          <IndicatorLabel>Pedidos pendientes</IndicatorLabel>
        </IndicatorContent>
      </IndicatorCard>
      ...
      >
        ...
        <IndicatorContent>
          ...
          <IndicatorLabel>Pedidos completados</IndicatorLabel>
        </IndicatorContent>
      </IndicatorCard>
    </IndicatorsContainer>
  );
